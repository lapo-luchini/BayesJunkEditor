...
public class TrainingData {
     ...
     */
    private TreeSet<MozillaSpamToken> tokenSet = null;
    ...
    public TrainingData(
            int goodMsgCount,
            int badMsgCount,
            TreeSet<MozillaSpamToken> newTokenSet) {
     ...
     */
    public TreeSet<MozillaSpamToken> getTokenSet() {
        return tokenSet;
    }
     ...
     * 				represents.
     */
    public void setTokenSet(TreeSet<MozillaSpamToken> set) {
        tokenSet = set;
    }
    ...
    public void outputTrainingDataFileContents(BufferedOutputStream outStream) throws IOException {
        ...
        while (tokenIter.hasNext()) {
            ...
            if (tempToken.getGoodTokenCount() > 0) {
                ...
                outStream.write(Globals.makeBytes(tempString.length()), 0, 4);
